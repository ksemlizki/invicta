...
<html lang="en" data-theme="Balzac">
    ...
    <head>
        ...
        <title>Invicta</title>
		<meta name="description" content="Моделям">
		<meta name="author" content="Моделям">
			...
			<div class="uk-grid uk-grid-divider" data-uk-grid-margin="" data-uk-grid-match="{target:'> div > .uk-panel'}">
				<div class="uk-width-medium-2-6">
					<div class="uk-panel uk-text-right uk-text-center-small  uk-flex-middle" >
						<img class="uk-thumbnail"  src="images/models-1.jpg" width="400" height="300" alt="Placeholder"><br>
				...
				<div class="uk-width-medium-4-6 uk-text-center-small">
					<div class="uk-panel" style="min-height: 81px;">
						<p style="font: normal 20px / 26px 'Droid Serif', serif;">
						Приглашаем моделей на перманентный макияж, микроблейдинг, наращивание ресниц, ламинирование и ботокс ресниц.
						<br><br>
						<b>Условия:</b><br>
						1. У Вас нет старого татуажа, микроблейдинга <br>
						2. У Вас нет противопоказаний к процедуре<br><br>

						В Контакте, Instagram  всегда идет поиск моделей - объявления появляются на стене. Добавляйтесь в друзья и следите за новостями <a href="https://www.instagram.com/shaigardanova39/" class="uk-icon-button uk-icon-instagram" target="_blank"></a>
                        <a href="https://m.vk.com/invicta39" class="uk-icon-button uk-icon-vk" target="_blank"></a><br>
						<b>Участие - бесплатно!</b></p>
